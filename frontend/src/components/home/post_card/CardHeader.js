      ...
      <div className="nav-item dropdown">
        ...
        <div className="dropdown-menu">
          {auth.user._id === post.user._id && (
            <>
              <div className="dropdown-item post-menu" onClick={handleEditPost}>
                <span className="material-icons text-info"> create</span>Edit
                Post
              </div>
              <div className="dropdown-item post-menu" onClick={handleDeletePost}>
          ...
          <div className="dropdown-item post-menu" onClick={handleCopyLink}>
            <span className="material-icons text-primary">content_copy</span>
            Copy Link
          </div>
          {auth.user._id !== post.user._id &&
            <div className="dropdown-item post-menu" onClick={handleReportPost}>
