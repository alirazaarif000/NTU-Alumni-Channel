...
export const updateProfileUser = ({formData, avatar, auth}) => async (dispatch) => {
  ...
  try {
    ...
    const res = await patchDataAPI("user", { ...formData, avatar: avatar ? media[0].url : auth.user.avatar }, auth.token);
